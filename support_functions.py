import random
from plotnine.scales.scale_xy import scale_y_reverse
...
import dill
import itertools
from plotnine import ggplot, aes,geom_tile,geom_text,facet_wrap,theme,element_blank,scale_fill_gradient2,scale_y_reverse
